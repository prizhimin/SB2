...
urlpatterns = [
    path('', daily_reports, name='daily_reports'),  # Маршрут по умолчанию для списка отчетов
    path('report/<int:report_id>/', report_details, name='report_details'),  # Маршрут для деталей отчета
